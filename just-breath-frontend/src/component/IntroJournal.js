		...
		return (
			<motion.div initial="out" animate="in" exit="out" variants={pageTransitions}>
				...
				<div className="intro-container">
					<p className="p-intro">
						Before you begin your adventures into <b>Just Breath,</b> please take a few minutes to write
						down anything you wish to express!
					</p>

					<p className="p-intro">
						This is a safe space to let out any negative thoughts, emotions, frustrations, and all of the
						above that have hindered you to feel at peace with yourself!{' '}
					</p>
